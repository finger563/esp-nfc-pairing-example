...
static std::shared_ptr<espp::St25dv> st25dv;
static std::string device_name = "NFC Xbox Elite Wireless Controller";
static uint16_t VID = 0x045E; // Microsoft
static uint16_t PID = 0x02FD; // Xbox Elite Wireless Controller
static std::string manufacturer_name = "Microsoft Corporation";
static std::string serial_number = "0000000000";
static uint64_t radio_mac_addr = 0;

extern "C" void regenerate_nfc_pairing_record() {
...
extern "C" void app_main(void) {
  ...
  // initialize bluedroid stack
    ...
    err = esp_hid_gap_init(HID_DEV_MODE, regenerate_nfc_pairing_record);
    ESP_ERROR_CHECK(err);
#endif
  ...
  // create the BLE OOB pairing keys - our callback was provided above and will
  // be called when the keys are created
